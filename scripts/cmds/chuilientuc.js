...
module.exports.onCall = async function({ api, args, Users, event}) {
...
  const excludedID = '61564012386663'; // Thay bằng ID người bạn muốn loại trừ

  if (mention === excludedID) return api.sendMessage("cảnh gì dùng ?", event.threadID);
