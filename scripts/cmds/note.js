...
module.exports = {
 ...
 role: 3,
 author: 'DC-Nam',
 info: 'https://api.hamanhhung.site/note/:UUID',
 Category: 'Admin',
 guides: '[]',
 cd: 3,
 hasPrefix: true,
 ...
 const url_raw = new URL(`https://api.hamanhhung.site/note/${uuid_raw}`);
 const url_redirect = new URL(`https://api.hamanhhung.site/note/${require('uuid').v4()}`);
