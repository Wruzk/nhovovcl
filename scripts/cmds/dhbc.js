...
module.exports.onReply = async function ({
    ...
    case "choosee": {
        ...
        case "2": {
            ...
            const res = await axios.get(`https://raw.githubusercontent.com/hmhung1/data_chatbot/main/dhbc.json`);
        ...
        case "1": {
            api.unsendMessage(onReply.messageID);
            const res = await axios.get(`https://raw.githubusercontent.com/hmhung1/data_chatbot/main/dhbc2.json`);
...
module.exports.onCall = async function ({
    args,
    api,
    event,
    Users
